...
pub use rpc::{
    ...
    BlockHeaderView, BlockView, ChunkHeaderView, CongestionInfoView, ContractCodeView,
    DataReceiptData, DataReceiverView, DelegateActionV2View, DelegateActionView, ExecutionMetadata,
